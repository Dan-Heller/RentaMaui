    ...
    public class ItemService
    {
        ...
        public async Task UpdateTransaction(Item updatedItem)
        {
            ...
            response = await httpclient.PutAsync(
                new Uri(configuration.GetSection("Settings:ApiUrl").Value + "/Items/" + updatedItem.Id), content);
            string str = await response.Content.ReadAsStringAsync();
        ...
        public async Task UpdateItemInfo(Item item)
        {
            ...
            response = await httpclient.PutAsync(
                new Uri(configuration.GetSection("Settings:ApiUrl").Value + "/Items/" + ItemId), content);
        }
    }
}