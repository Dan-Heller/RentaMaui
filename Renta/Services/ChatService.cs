    ...
    public class ChatService
    {
        ...
        public ChatService(IConfiguration config, UserService userService)
        {
            ...
            _connection = new HubConnectionBuilder()
                .WithUrl(configuration.GetSection("Settings:ApiUrl").Value + "/chat?userid=" + userId).Build();
        ...
        {
            MessageDto messageDto = new MessageDto(userId, currentMessagesPage._currentChatViewModel.OtherUserId,
                message, currentMessagesPage._currentChat.Id, DateTime.Now);
        ...
        public async Task<Chat> CreateNewChat(CreateChatDto createChatDto)
        {
            ...
            response = await httpclient.PostAsync(
                new Uri(configuration.GetSection("Settings:ApiUrl").Value + "/Users/Chat/"), content);
