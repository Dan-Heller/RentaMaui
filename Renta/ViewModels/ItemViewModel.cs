...
namespace Renta.ViewModels
{
    public class ItemViewModel : BaseViewModel
    {
        ...
        {
            get => Item?.PricePerDay;
        }

        public string? Description
        {
            get => Item?.Description.Trim();
        }
        ...
        public List<DatesRange>? UnAvailableDates
        {
            get => Item?.UnAvailableDates;
        }

        public string? UploadDate
        {
            get => Item.UploadDate.Value.Date.ToString("dd/MM/yyyy");
        }
        ...
        {
            get { return ImagesUrls[CurrentImageIndex % ImagesUrls.Count]; }
        }
